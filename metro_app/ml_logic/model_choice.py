...
def choose_model(df, number_hours, key_to_json):
    ...
    for station, station_line in unique_list:
        ...
        try :
            ...
            if mape_prophet == 0 :
                ...
                #     print('File has been uploaded to gcp (mstl)')

                serialized_model = pickle.dumps(model)
                print(upload(serialized_model,file_name=f'models/model_station_{station_number}.pkl', path_to_json_key=key_to_json))
                print(upload(prediction_prophet.to_csv(), file_name=f'data/pred/data_pred_station_{station_number}.csv', path_to_json_key=key_to_json ))
